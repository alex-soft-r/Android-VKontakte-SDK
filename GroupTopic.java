...
public class GroupTopic implements Serializable {
    ...
    public int is_fixed;
    public int comments;
    public String first_comment;//me
    public String last_comment;//me
    ...
    public static GroupTopic parse(JSONObject o) throws NumberFormatException, JSONException {
        ...
        topic.first_comment = Api.unescape(o.optString("first_comment"));
        topic.last_comment = Api.unescape(o.optString("last_comment"));
        return topic;
    }
