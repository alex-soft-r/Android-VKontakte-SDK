...
public class Api {
    ...
    public ArrayList<Place> getPlaces(String q, int city, double latitude, double longitude,
            int radius, int offset, int count) throws IOException, JSONException, KException {
        Params params = new Params("places.search");
        if(q != null || !q.isEmpty())
            params.put("q", q);
        if(city != -1)
        ...
        return Place.parsePlaces(array.optJSONArray("items"));
    }
    //add by me
    //http://vkontakte.ru/developers.php?o=-1&p=photos.createComment
    public long createPlacesChekin(Long pid, String text, double latitude, double longitude, boolean friends_only, ArrayList<String> services, String captcha_key, String captcha_sid) throws MalformedURLException, IOException, JSONException, KException{
        Params params = new Params("places.checkin");
        if(pid<0)
            return -1;
        ...
        params.put("friends_only",friends_only==true?1:0);
//      String services_ = "";
//      params.put("services",friends_only==true?1:0);
    ...
    //http://vk.com/dev/groups.get
    public ArrayList<Group> getUserGroups2(Long user_id, String fields) throws IOException, JSONException, KException{
        Params params = new Params("groups.get");
        params.put("extended","1");
        params.put("user_id",user_id);
        params.put("fields", fields);
    ...
    public ArrayList<GroupTopic> getGroupTopics(long gid, Integer order, int extended, int count, int offset) throws IOException, JSONException, KException {
        ...
        params.put("preview", "3");//вернуть вместе с информацией о темах текст первых и последних сообщений
        if (extended == 1)
